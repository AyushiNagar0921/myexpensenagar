...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'Add Income', path: '/add-income', icon: <PlusCircle className="h-5 w-5" /> },
    { name: 'Add Expense', path: '/add-expense', icon: <PlusCircle className="h-5 w-5" /> },
    { name: 'Transactions', path: '/transactions', icon: <BarChart3 className="h-5 w-5" /> },
    { name: 'Goals', path: '/goals', icon: <PiggyBank className="h-5 w-5" /> },
    { name: 'Loans', path: '/loans', icon: <CreditCard className="h-5 w-5" /> },
